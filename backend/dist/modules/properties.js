...
const createSchema = zod_1.z.object({
    ...
    wifi_ssid: zod_1.z.string().optional(),
    wifi_password: zod_1.z.string().optional(),
...
async function ensurePropertyColumns() {
    ...
    await dbAdapter_1.pgPool.query('ALTER TABLE properties ADD COLUMN IF NOT EXISTS wifi_ssid text');
    await dbAdapter_1.pgPool.query('ALTER TABLE properties ADD COLUMN IF NOT EXISTS wifi_password text');
