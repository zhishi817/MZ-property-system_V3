...
CREATE INDEX IF NOT EXISTS idx_employment_contracts_status_updated ON employment_contracts(status, updated_at DESC);
CREATE INDEX IF NOT EXISTS idx_employment_contracts_employee_name ON employment_contracts ((fields->>'employee_name'));
...
CREATE UNIQUE INDEX IF NOT EXISTS uniq_property_annual_report_manual_months_property_month ON property_annual_report_manual_months(property_id, month_key);
CREATE INDEX IF NOT EXISTS idx_property_annual_report_manual_months_fy ON property_annual_report_manual_months(fiscal_year, property_id, month_key);
