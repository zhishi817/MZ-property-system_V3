...
const READINESS_QUERIES = [
  `SELECT id, property_id, occurred_at, details, created_by, created_at,
          ...
          photo_urls, repair_photo_urls, repair_notes, completion_reason, category_detail, work_no, area,
  ...
  `SELECT id, order_no, client_name, details, status, assignee_id, scheduled_date,
          completion_photo_urls, completion_notes, completion_reason, reviewed_at, reviewed_by, review_note,
  ...
  `SELECT id, task_kind, source_type, source_id, property_id, title, summary,
          scheduled_date, start_time, end_time, assignee_id, status, urgency, sort_index, photo_urls,
          completion_photo_urls, completion_note,
          completion_reason, created_by, updated_by,
