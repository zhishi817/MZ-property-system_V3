    ...
    children: [
      {
        ...
        label: '公司内容中心',
        href: '/cms/company',
        visibleWhenAny: ['menu.cms.company.visible', 'menu.cms.customer_service_manual.visible', 'cms_pages.view'],
        rbacKey: 'menu.cms.company.visible',
        actionPerms: ['cms_pages.view', 'cms_pages.write', 'cms_pages.delete', 'cms_pages.archive'],
      },
      {
        id: 'cms-public-resources',
        label: '公开指南与外链',
        href: '/cms/public-resources',
        visibleWhenAny: ['menu.cms.public_resources.visible', 'menu.cms.public_cleaning.visible', 'menu.cms.public_cleaning_password.visible', 'cms_public_access.manage'],
        rbacKey: 'menu.cms.public_resources.visible',
        actionPerms: ['cms_pages.view', 'cms_pages.write', 'cms_pages.delete', 'cms_pages.archive', 'cms_public_access.manage'],
      },
      {
        id: 'cms-offline-passwords',
        label: '线下密码管理',
        href: '/cms/offline-passwords',
        visibleWhenAny: ['menu.cms.offline_passwords.visible', 'company_secret_items.view'],
        rbacKey: 'menu.cms.offline_passwords.visible',
        actionPerms: ['company_secret_items.view', 'company_secret_items.write', 'company_secret_items.delete'],
      },
    ],
  },
  {
